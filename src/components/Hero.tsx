    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <span className="text-neutral-200 font-medium">Capgemini</span> with a focus on React,
          TypeScript, and Full-Stack efficiency. Building interfaces that scale.
        </motion.p>

        <motion.div {...fadeUp(0.45)} className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <a
            href="#projects"
